...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-capture-templates
        (quote (("l" "Ledger entries")
                ("lr" "RAW" plain (file
                                    (concat org-directory "/ledger.dat"))
                 "%(org-read-date) * %^{Payee}
  %^{FromAccount}
  %^{ToAccount}  %^{Amount} BGN
  ")
                ("lc" "Cash" plain (file
                                    (concat org-directory "/ledger.dat"))
                 "%(org-read-date) * %^{Payee}
  ...
  ")
                ("t" "Todo" entry (file
                                   (concat org-directory "/refile.org.gpg"))
                 "* TODO %?\n:PROPERTIES:\n:Effort: %^{effort|0:15|0:30|0:45|1:00|2:00|3:00|4:00|5:00|6:00|0:00}\n:END:\n%U\n%a\n" :clock-in t :clock-resume t)
                ...
                ("j" "Journal" entry (file+datetree
                 ...
                 "* %?\n%[jnl.txt]\n%U\n" :clock-in t :clock-resume t)
                ("c" "Conditionning" entry (file+headline
                                            (concat org-directory "/roles/selfimprover.org.gpg")
                                            "NEXT Експлозивно начало на деня")
                 "* Smile Dimitar %u\n%[powerEval.txt]\n%U\n" :clock-in t :clock-resume t)
...
#+BEGIN_SRC emacs-lisp
  (setq org-agenda-files
        (append (file-expand-wildcards
               (concat org-directory "/*.org.gpg"))
               (file-expand-wildcards
                (concat org-directory "/roles/*.org.gpg"))
  ;;              (file-expand-wildcards
  ;;               (concat org-directory "/luxoft/*.org.gpg"))
  ;;             (file-expand-wildcards
  ;;              (concat org-directory "/amdocs/*.org.gpg"))
               ))
        ...
        (quote (("N" "Notes" tags "NOTE"
                ...
                (" " "Agenda"
                 ((agenda "" nil)
                  ...
                  (tags "MUND"
                        ((org-agenda-overriding-header "Mundane Taks")
                         (org-tags-match-list-sublevels nil)))
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-todo-keyword-faces
        (quote (("TODO" :foreground "red" :weight bold)
                ...
                ("MUND" :foreground "cyan" :weight bold)
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Exclude from tag inheritance following tags
...
*** Execute babel blocks without confirmation
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq ledger-expense-completions
        (list
         ...
         "Expenses:Food" "Expenses:Food:Restraunts" "Expenses:Food:Groceries" "Expenses:Flat:Rent" "Expenses:Flat:Utilities" "Expenses:Goods" "Expenses:Electronics" "Expenses:Electronics:Parts" "Expenses:Transport" "Expenses:Services" "Expenses:Entertainment" "Expenses:Auto:Diesel" "Expenses:Auto:Service" "Expenses:Sport" "Expenses:SelfImprovement"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq yas-snippet-dirs
        '("~/.emacs.d/snippets"                     ;; default colleciton
          "~/.emacs.d/plugins/personal_snippets"    ;; personal snippets
          ))
...
** COMMENT Company and yasnippet for python
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (defun dp/python-add-breakpoint ()
    "Add a break point"
    (interactive)
    (newline-and-indent)
  ...
  (define-key python-mode-map (kbd "C-c b") 'dp/python-add-breakpoint)

  (defun dp/python-interactive ()
  ...
  (global-set-key (kbd "C-c i") 'dp/python-interactive)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (add-to-list 'load-path "~/.emacs.d/plugins/isend-mode")
  (require 'isend) 
#+END_SRC
